...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal protocol Tinkoff_Public_Invest_Api_Contract_V1_OrdersStreamServiceAsyncProvider: CallHandlerProvider, Sendable {
    static var serviceDescriptor: GRPCServiceDescriptor { get }
    var interceptors: Tinkoff_Public_Invest_Api_Contract_V1_OrdersStreamServiceServerInterceptorFactoryProtocol? { get }
    ...
    internal func handle(
        ...
        case "TradesStream":
            return GRPCAsyncServerHandler(
                ...
                responseSerializer: ProtobufSerializer<Tinkoff_Public_Invest_Api_Contract_V1_TradesStreamResponse>(),
                interceptors: self.interceptors?.makeTradesStreamInterceptors() ?? [],
                wrapping: { try await self.tradesStream(request: $0, responseStream: $1, context: $2) }
            )
...
internal protocol Tinkoff_Public_Invest_Api_Contract_V1_OrdersStreamServiceServerInterceptorFactoryProtocol: Sendable {
...
/// To implement a server, implement an object which conforms to this protocol.
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal protocol Tinkoff_Public_Invest_Api_Contract_V1_OrdersServiceAsyncProvider: CallHandlerProvider, Sendable {
    static var serviceDescriptor: GRPCServiceDescriptor { get }
    var interceptors: Tinkoff_Public_Invest_Api_Contract_V1_OrdersServiceServerInterceptorFactoryProtocol? { get }
    ...
    internal func handle(
        ...
        case "GetOrderState":
            return GRPCAsyncServerHandler(
                ...
                responseSerializer: ProtobufSerializer<Tinkoff_Public_Invest_Api_Contract_V1_OrderState>(),
                interceptors: self.interceptors?.makeGetOrderStateInterceptors() ?? [],
                wrapping: { try await self.getOrderState(request: $0, context: $1) }
            )
        ...
        case "ReplaceOrder":
            return GRPCAsyncServerHandler(
                ...
                responseSerializer: ProtobufSerializer<Tinkoff_Public_Invest_Api_Contract_V1_PostOrderResponse>(),
                interceptors: self.interceptors?.makeReplaceOrderInterceptors() ?? [],
                wrapping: { try await self.replaceOrder(request: $0, context: $1) }
            )
...
internal protocol Tinkoff_Public_Invest_Api_Contract_V1_OrdersServiceServerInterceptorFactoryProtocol: Sendable {
