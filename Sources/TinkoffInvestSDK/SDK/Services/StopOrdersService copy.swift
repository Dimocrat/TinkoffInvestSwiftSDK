...
public protocol OrdersService: AnyObject {
    ...
    func postOrder(request: PostStopOrderRequest) -> AnyPublisher<PostStopOrderResponse, RPCError>

    func getOrders(request: GetOrdersRequest) -> AnyPublisher<GetStopOrdersResponse, RPCError>

    func cancelStopOrders(request: CancelOrderRequest) -> AnyPublisher<CancelOrderResponse, RPCError>
    
    func getOrdersStateRequest: GetOrderStateRequest) -> AnyPublisher<OrderState, RPCError>
